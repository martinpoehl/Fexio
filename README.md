# BizManager – Next.js + Vercel + Supabase
...
```bash
git remote add origin https://github.com/DEIN-USERNAME/bizmanager.git
git branch -M main
...
4. Klicke **Deploy**
5. In ~60 Sekunden ist die App live unter `bizmanager.vercel.app`
...
1. Die Komponenten aus der HTML-Version (BizManager-bexio.html) als
